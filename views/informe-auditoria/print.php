        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">	  
                    ...
                    <h3 class="panel-title text-center"> INFORME AUDITORIA DEPENDENCIA : <?=$dependencia->codigo_dependencia.' - '.strtoupper($dependencia->denominacion)?> </h3>
                </div>		
            </div>				
        </div>
    </head>
                    ...
                    <div class="panel-body">
                        <table BORDER=1 CELLPADDING=5 CELLSPACING=1>
                            <tr>
                                ...
                                <th class="text-center" scope="col">VALOR DE ORIGEN</th>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><h6><?= $models->rubro?$models->rubro->strRubro:'-' ?></h6></td> 
                                ...
                                <td class="text-center"><h6><?= $models->precio_origen?$models->precio_origen:'-'  ?></h6></td>
