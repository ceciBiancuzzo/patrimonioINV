...
echo Dialog::widget([
  ...
  Modal::begin([
    'header' => '<h2></h2>',
    'headerOptions' => ['id' => 'modalAdquisicionHeader'],
    'id' => 'modalAdquisicion',
  ...
  echo "<div id='modalContentAdquisicion'>Cargando... Espere...</div>";
  Modal::end();
$titulo = 'Forma Adquisición';
$this->title = $titulo;
$this->params['breadcrumbs'][] = $this->title;


?>
<div class="patrimonio-forma-adquisicion-index" >
   ...
   <?php
        ...
        $opcion_update = function ($url,$dataProvider) {
            ...
            return "   ".Html::button('<span class="glyphicon glyphicon-pencil"></span>', 
                                        ['title'=>'Editar Adquisición','name' => 'btEditar', 
                                        'value' => \yii\helpers\Url::to(['patrimonio-forma-adquisicion/update','id'=>$dataProvider->id]),
                                        'class' => 'btn btn-info']);
     ...
     $opcion_delete = function ($url,$dataProvider) {
           ...
           return "   ".Html::button('<span class="glyphicon glyphicon-trash"></span>', 
                                        ['title'=>'Eliminar Adquisición','name' => 'btEliminar',
                                        'value' => \yii\helpers\Url::to(['patrimonio-forma-adquisicion/delete','id'=>$dataProvider->id]),
    ...
    if (strpos($perfil, 'Administrador')== 1){
     echo( Html::button('
     <span class="glyphicon glyphicon-pencil"></span> Nueva Adquisición', ['id' => 'btNuevo','value' => \yii\helpers\Url::to(['patrimonio-forma-adquisicion/create']), 'class' => 'btn btn-success',]) );
    }
     ?>
    ...
    <div  class="well">
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<h3 class="panel-title text-center"><i class="glyphicon glyphicon-inbox"> </i> Lista de Forma adquisición del Bien</h3>',
            ],  
            'toolbar' =>  [ 
                ['content'=>
...
$("#btNuevo").click(function(){
    ...
    $("button[name*=\'btEditar\']").click(function(){
        $("#modalAdquisicionHeader").find("h2").html("Modificar Adquisicion");
        $("#modalAdquisicion").modal("show")
            .find("#modalContentAdquisicion")
            .load($(this).attr("value"));
