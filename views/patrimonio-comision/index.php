...
echo Dialog::widget([
  ...
  echo "<div id='modalContentComision'>Cargando... Espere...</div>";
  Modal::end();
$titulo = 'Comisiones';
$this->title = $titulo;
   ...
   <?php
        ...
        $opcion_update = function ($url,$dataProvider) {
            ...
            return "   ".Html::button('<span class="glyphicon glyphicon-pencil"></span>', 
                                        ['title'=>'Editar Comision','name' => 'btEditar', 
                                        'value' => \yii\helpers\Url::to(['patrimonio-comision/update','id'=>$dataProvider->id]),
                                        'class' => 'btn btn-info']);
     ...
     $opcion_delete = function ($url,$dataProvider) {
           ...
           return "   ".Html::button('<span class="glyphicon glyphicon-trash"></span>', 
                                        ['title'=>'Eliminar Comision','name' => 'btEliminar',
                                        'value' => \yii\helpers\Url::to(['patrimonio-comision/delete','id'=>$dataProvider->id]),
    ...
    if (strpos($perfil, 'Administrador')== 1){
     ...
     echo( Html::button('
     <span class="glyphicon glyphicon-pencil"></span> Nueva Comision', ['id' => 'btNuevo','value' => \yii\helpers\Url::to(['patrimonio-comision/create']), 'class' => 'btn btn-success',]) );
    }
     ?>
    ...
    <div  class="well">
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<h3 class="panel-title text-center"><i class="glyphicon glyphicon-inbox"> </i> Comisiones</h3>',
            ],  
            'pager' => [
...
<?php 
$url = \yii\helpers\Url::to(['patrimonio-comision/create']) ;
...
$("#btNuevo").click(function(){
    ...
    $("button[name=\'btEliminar\']").click(function(){
        ...
        krajeeDialog.confirm("Desea eliminar La comision?", function (result) {
    ...
    $("button[name*=\'btEditar\']").click(function(){
        $("#modalDetalleHeader").find("h2").html("Modificar Comision");
        $("#modalContentComision").modal("show")
            .find("#modalContentComision")
            .load($(this).attr("value"));
