...
?>
<div class="patrimonio-estados-formularios-index" >
   ...
   <?php
        ...
        $opcion_update = function ($url,$dataProvider) {
            ...
            return "   ".Html::button('<span class="glyphicon glyphicon-pencil"></span>', 
                                        ...
                                        'value' => \yii\helpers\Url::to(['patrimonio-estados-formularios/update','id'=>$dataProvider->id]),
                                        'class' => 'btn btn-info']);
     ...
     $opcion_delete = function ($url,$dataProvider) {
           ...
           return "   ".Html::button('<span class="glyphicon glyphicon-trash"></span>', 
                                        ...
                                        'value' => \yii\helpers\Url::to(['patrimonio-estados-formularios/delete','id'=>$dataProvider->id]),
    ...
    if (strpos($perfil, 'Administrador')== 1){
     echo( Html::button('
     <span class="glyphicon glyphicon-pencil"></span> Nueva Estado Formulario', ['id' => 'btNuevo','value' => \yii\helpers\Url::to(['patrimonio-estados-formularios/create']), 'class' => 'btn btn-success',]) );
    }
     ?>
    ...
    <div  class="well">
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<h3 class="panel-title text-center"><i class="glyphicon glyphicon-inbox"> </i> Lista de estados del Formulario</h3>',
            ],  
            'toolbar' =>  [ 
                ['content'=>
...
$("#btNuevo").click(function(){
    ...
    $("button[name*=\'btEditar\']").click(function(){
        $("#modalDetalleHeader").find("h2").html("Modificar Estado Formulario");
