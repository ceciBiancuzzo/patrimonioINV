...
echo Dialog::widget([
  ...
  Modal::begin([
    'header' => '<h2></h2>',
    'headerOptions' => ['id' => 'modalDetalleHeader'],
    'id' => 'modalContentEstadoFormulario',
    'size' => 'modal-lg modal-scroll',
    'options' => [
        'tabindex' => false, // important for Select2 to work properly
        'style'=>'overflow:hidden;',
  ...
  echo "<div id='modalContentEstadoFormulario'>Cargando... Espere...</div>";
  Modal::end();
...
?>
<div class="patrimonio-usuarios-externos-index" >
   ...
   <?php
        ...
        $opcion_update = function ($url,$dataProvider) {
            ...
            return "   ".Html::button('<span class="glyphicon glyphicon-pencil"></span>', 
                                        ['title'=>'Editar Usuario','name' => 'btEditar', 
                                        'value' => \yii\helpers\Url::to(['patrimonio-usuarios-externos/update','id'=>$dataProvider->id]),
                                        'class' => 'btn btn-info']);
     ...
     $opcion_delete = function ($url,$dataProvider) {
           ...
           return "   ".Html::button('<span class="glyphicon glyphicon-trash"></span>', 
                                        ['title'=>'Eliminar Usuario','name' => 'btEliminar',
                                        'value' => \yii\helpers\Url::to(['patrimonio-usuarios-externos/delete','id'=>$dataProvider->id]),
    ...
    //                             }   ;
        ...
        $gridColumns = [
            ...
            'nombre_usuario',
            ['attribute'=>'id_dependencia','label'=>'Denominación','value'=>function($model){
                return $model->strArea?$model->strArea->denominacion:" - ";
                },
            ], 
            'dni',
            'telefono',   
    ...
    if (strpos($perfil, 'Administrador')== 1){ 
     echo( Html::button('
     <span class="glyphicon glyphicon-pencil"></span> Nuevo Usuario Externo', ['id' => 'btNuevo','value' => \yii\helpers\Url::to(['patrimonio-usuarios-externos/create']), 'class' => 'btn btn-success',]) );
    ...
    <div  class="well">
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<h3 class="panel-title text-center"><i class="glyphicon glyphicon-inbox"> </i> Lista de usuarios externos</h3>',
            ],  
            'toolbar' =>  [ 
                ['content'=>
...
<?php 
$url = \yii\helpers\Url::to(['patrimonio-usuarios-externos/create']) ;
...
$("#btNuevo").click(function(){
    ...
    $("button[name=\'btEliminar\']").click(function(){
        ...
        krajeeDialog.confirm("Desea eliminar el usuario?", function (result) {
    ...
    $("button[name*=\'btEditar\']").click(function(){
        $("#modalDetalleHeader").find("h2").html("Modificar Usuario Externo");
        $("#modalContentEstadoFormulario").modal("show")
            .find("#modalContentEstadoFormulario")
            .load($(this).attr("value"));
