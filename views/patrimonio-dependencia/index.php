   ...
   <?php
        ...
        $opcion_update = function ($url,$dataProvider) {
            ...
            return "   ".Html::button('<span class="glyphicon glyphicon-pencil"></span>', 
                                        ...
                                        'value' => \yii\helpers\Url::to(['patrimonio-dependencia/update','id'=>$dataProvider->id]),
                                        'class' => 'btn btn-info']);
     ...
     $opcion_delete = function ($url,$dataProvider) {
           ...
           return "   ".Html::button('<span class="glyphicon glyphicon-trash"></span>', 
                                        ...
                                        'value' => \yii\helpers\Url::to(['patrimonio-dependencia/delete','id'=>$dataProvider->id]),
    ...
    //                             }   ;
        ...
        $gridColumns = [
            ...
            ['attribute'=>'codigo_dependencia','label'=>'Código de dependencia','value'=>function($model){
                if($model->codigo_dependencia){
               return $model->codigo_dependencia;
               }else{
                   return "-";
               }
           }
            ...
            ['attribute'=>'id','label'=>'Jefe de area','value'=>function($model){
                if($model->strJefe){
               return $model->strJefe->strAgente;
               }else{
                   return "-";
               }
           }
            ],
            ['attribute'=>'id_organigrama','label'=>'Área organigrama','value'=>function($model){
                if($model->area){
               return $model->area->desc_desempenio;
               }else{
                   return "-";
               }
           }
    ...
    <?php
          if (strpos($perfil, 'Administrador')== 1){
            echo( Html::button('
            <span class="glyphicon glyphicon-pencil"></span> Nueva área', ['id' => 'btNuevo','value' => \yii\helpers\Url::to(['patrimonio-dependencia/create']), 'class' => 'btn btn-success',]) );
           }
    ...
    <div  class="well">
        <?= GridView::widget([
            ...
            'panel' => [
                ...
                'heading' => '<h3 class="panel-title text-center"><i class="glyphicon glyphicon-inbox"> </i> Lista de áreas</h3>',
            ],  
            'pager' => [
