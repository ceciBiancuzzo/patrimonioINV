...
/**
 * PatrimonioDependenciaSearch represents the model behind the search form of `patrimonio\parametros\PatrimonioDependencia`.
 */
class PatrimonioDependenciaSearch extends PatrimonioDependencia
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'codigo_dependencia', 'id_usuario_carga', 'id_usuario_baja', 'id_usuario_modificacion','id_encargado','id_encargado2','id_organigrama'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'id' => $this->id,
            'codigo_dependencia' => $this->codigo_dependencia,
            ...
            'id_encargado2'=>$this->id_encargado2,
            'id_organigrama'=>$this->id_organigrama,
        ]);
